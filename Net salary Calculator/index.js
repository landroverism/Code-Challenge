...
// calculating the net salary of an employee earning below 24,000 using NHIF rate of 2.5% and NSSF rate of 6%.
  ...
  document.getElementById("net").innerHTML = `Your net salary is ${netSalary.toFixed(2)}, PAYEE TAX: ${tax.toFixed(2)}, NHIF DEDUCTIONS: ${nhif.toFixed(2)}, NSSF DEDUCTIONS: ${nssf.toFixed(2)}`;
}
